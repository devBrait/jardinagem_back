...
const fornecedorController_1 = require("../api/controllers/fornecedorController");
const fornecedorRouter = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 *   name: Fornecedores
 ...
 */
fornecedorRouter.post('/', fornecedorController_1.cadastroAsync);
/**
 * @swagger
 * /fornecedores/login:
 *   post:
 ...
 */
fornecedorRouter.post('/login', fornecedorController_1.loginAsync);
